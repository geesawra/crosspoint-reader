...
inline SettingInfo buildFontFamilySetting(const SdCardFontRegistry* registry) {
  ...
  std::vector<StrId> enumValues = {StrId::STR_BOOKERLY, StrId::STR_NOTO_SERIF, StrId::STR_NOTO_SANS};
  ...
  static const std::vector<SettingInfo> baseList = [] {
    std::vector<SettingInfo> v = {
        ...
        SettingInfo::Enum(StrId::STR_FONT_FAMILY, &CrossPointSettings::fontFamily,
                          {StrId::STR_BOOKERLY, StrId::STR_NOTO_SERIF, StrId::STR_NOTO_SANS}, "fontFamily",
        ...
        SettingInfo::Toggle(StrId::STR_RIL_IMAGES, &CrossPointSettings::readItLaterImages, "readItLaterImages",
                            StrId::STR_CAT_SYSTEM),
