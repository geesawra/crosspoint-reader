...
static constexpr EntityPair ENTITY_LOOKUP[] = {
    ...
    {"&darr;", "↓"},       {"&deg;", "°"},         {"&delta;", "δ"},      {"&diams;", "♦"},      {"&divide;", "÷"},
    {"&eacute;", "é"},     {"&ecirc;", "ê"},       {"&egrave;", "è"},     {"&empty;", "∅"},      {"&emsp;", " "},
    {"&ensp;", " "},       {"&epsilon;", "ε"},     {"&equiv;", "≡"},      {"&eta;", "η"},        {"&eth;", "ð"},
    {"&euml;", "ë"},       {"&euro;", "€"},        {"&exist;", "∃"},      {"&fnof;", "ƒ"},       {"&forall;", "∀"},
    {"&frac12;", "½"},     {"&frac14;", "¼"},      {"&frac34;", "¾"},     {"&frasl;", "⁄"},      {"&gamma;", "γ"},
    {"&ge;", "≥"},         {"&gt;", ">"},          {"&harr;", "↔"},       {"&hearts;", "♥"},     {"&hellip;", "…"},
    {"&iacute;", "í"},     {"&icirc;", "î"},       {"&iexcl;", "¡"},      {"&igrave;", "ì"},     {"&infin;", "∞"},
    {"&int;", "∫"},        {"&iota;", "ι"},        {"&iquest;", "¿"},     {"&isin;", "∈"},       {"&iuml;", "ï"},
    {"&kappa;", "κ"},      {"&lambda;", "λ"},      {"&laquo;", "«"},      {"&larr;", "←"},       {"&lceil;", "⌈"},
    ...
    {"&prod;", "∏"},       {"&prop;", "∝"},        {"&psi;", "ψ"},        {"&quot;", "\""},      {"&radic;", "√"},
    {"&raquo;", "»"},      {"&rarr;", "→"},        {"&rceil;", "⌉"},      {"&rdquo;", "\u201D"}, {"&reg;", "®"},
    {"&rfloor;", "⌋"},     {"&rho;", "ρ"},         {"&rlm;", "\u200F"},   {"&rsaquo;", "›"},     {"&rsquo;", "\u2019"},
    {"&sbquo;", "‚"},      {"&scaron;", "š"},      {"&sdot;", "⋅"},       {"&sect;", "§"},       {"&shy;", "\xC2\xAD"},
    ...
    {"&times;", "×"},      {"&trade;", "™"},       {"&uacute;", "ú"},     {"&uarr;", "↑"},       {"&ucirc;", "û"},
